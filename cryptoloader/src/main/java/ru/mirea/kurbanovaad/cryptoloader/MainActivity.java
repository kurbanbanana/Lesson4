package ru.mirea.kurbanovaad.cryptoloader;
...
import ru.mirea.kurbanovaad.cryptoloader.databinding.ActivityMainBinding;
...
public	class MainActivity extends	AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    // Изменения в этом методе
    public static final String ARG_KEY = MyLoader.ARG_KEY;
    public static final String ARG_TEXT = MyLoader.ARG_TEXT;
    @Override
